...
const submodule: SubModule = {
  ...
  items: [
    { id: 'greeting-hi', label: 'Hi', videoPath: videoUrl('/videos/greetings/hi.mp4'), acceptedAnswers: ['hi'] },
    { id: 'greeting-hello', label: 'Hello', videoPath: videoUrl('/videos/greetings/hello.mp4'), acceptedAnswers: ['hello'] },
    { id: 'greeting-good-morning', label: 'Good Morning', videoPath: videoUrl('/videos/greetings/good-morning.mp4'), acceptedAnswers: ['good morning'] },
